...
const INVENTORY: &[Algorithm] = &[
    ...
    a("online.FfmRegressor", "river.facto.FFMRegressor", "online"),
    ...
    a("online.ComposePipeline", "river.compose.Pipeline", "online"),
    ...
    a("online.SfmRegressor", "river.facto.SFMRegressor", "online"),
    a(
        "tsa.TrendForecaster",
        "sktime.forecasting.trend.TrendForecaster",
        "forecast",
    ...
    a("tsa.ArchInMean", "arch.univariate.ARCH", "forecast"),
    ...
    a("online.HyperLogLog", "river.sketch.HyperLogLog", "online"),
    a(
        "online.OnlineVoting",
    ...
    a("online.HeavyHitters", "river.sketch.HeavyHitters", "online"),
    a(
    ...
    a("stats.brunner_munzel", "scipy.stats.brunnermunzel", "stats"),
    a(
        "stats.jonckheere",
    ...
    a(
        "stats.bowker",
        "statsmodels.stats.contingency_tables.bowker",
        "stats",
    ),
    a(
    ...
    a(
        "tsa.EnbPI",
        "sktime.forecasting.enbpi.EnbPIForecaster",
        "forecast",
    ),
    a(
        "tsa.HamiltonFilter",
    ...
    a(
        "online.RollingMedian",
        "river.stats.RollingQuantile",
        "online",
    ),
    ...
    a(
        "online.OnlinePeakToPeak",
        "river.stats.PeakToPeak",
        "online",
    ),
    a(
        "glm.TruncatedLogit",
    ...
    a("stats.savgol_filter", "scipy.signal.savgol_filter", "stats"),
    a(
    ...
    a(
        "tslearn.cdist_sbd",
        "tslearn.metrics.cdist_sbd",
        "timeseries",
    ),
    a("online.MinHash", "river.sketch.MinHash", "online"),
    a("online.BernoulliProba", "river.proba.Bernoulli", "online"),
    a(
    ...
    a("online.RollingLogLoss", "river.metrics.LogLoss", "online"),
    a("online.RollingPinball", "river.metrics.Pinball", "online"),
    a("online.RollingHuber", "river.metrics.Huber", "online"),
    a("tslearn.cdist_wdtw", "tslearn.metrics.cdist", "timeseries"),
    a(
        "glm.BayesMixedGLM",
        "statsmodels.genmod.bayes_mixed_glm.BayesMixedGLM",
        "estimator",
    ),
    a("tslearn.Binseg", "ruptures.detection.Binseg", "timeseries"),
    a("tslearn.cdist_ddtw", "tslearn.metrics.cdist", "timeseries"),
    a("online.RollingLogCosh", "river.metrics.LogCosh", "online"),
    a(
        "online.RollingCrossEntropy",
        "river.metrics.CrossEntropy",
        "online",
    ),
    a("online.RollingAccuracy", "river.metrics.Accuracy", "online"),
    ...
    a("online.RollingJaccard", "river.metrics.Jaccard", "online"),
    a("online.RollingHamming", "river.metrics.Hamming", "online"),
    ...
    a("glm.GompertzAft", "lifelines.GompertzFitter", "estimator"),
    a(
        "iv.sargan",
        "statsmodels.sandbox.regression.gmm.IV2SLS",
        "function",
    ...
    a("online.OnlineHistogram", "river.sketch.Histogram", "online"),
    ...
    a(
        "panel.SystemGmm",
        "linearmodels.panel.model.SystemGMM",
        "estimator",
    ),
    ...
    a(
        "online.AdafactorRegressor",
        "river.optim.Adafactor",
        "online",
    ),
    a(
        "online.AdaBeliefRegressor",
        "river.optim.AdaBelief",
        "online",
    ),
    ...
    a(
        ...
        "tslearn.decomposition.TimeSeriesPCA",
        "estimator",
    ),
    a(
    ...
    a(
        "stats.brier_survival",
        "sksurv.metrics.brier_score",
        "function",
    ),
    a(
        "stats.exponential_fitter",
        "lifelines.ExponentialFitter",
        "function",
    ),
    a(
        "stats.ExponentialFitter",
        "lifelines.ExponentialFitter",
        "estimator",
    ),
    a(
        "stats.weibull_fitter",
    ...
    a(
        "online.SamKnn",
        "river.neighbors.SAMKNNClassifier",
        "online",
    ),
    a("online.OnlineOneClassSvm", "river.anomaly.SVM", "online"),
    a(
        "online.FwFmRegressor",
        "river.facto.FwFMRegressor",
        "online",
    ),
    a(
        "online.MultivariateGaussian",
        "river.proba.MultivariateGaussian",
        "online",
    ),
    a(
        "online.ScaleCovariances",
        "river.preprocessing.ScaleCovariances",
        "online",
    ),
    a(
    ...
    a(
        "tslearn.SoftDtwBarycenter",
        "tslearn.barycenters.softdtw_barycenter",
        "estimator",
    ),
    a(
        "tslearn.ShapeletModel",
        "tslearn.shapelets.ShapeletModel",
        "estimator",
    ),
    a(
    ...
    a(
        "tslearn.TimeSeriesSvd",
        "tslearn.decomposition.TimeSeriesSVD",
        "estimator",
    ),
    a(
        "stats.lognormal_fitter",
    ...
    a(
        "stats.loglogistic_fitter",
        "lifelines.LogLogisticFitter",
        "function",
    ),
    a(
        "stats.LogLogisticFitter",
        "lifelines.LogLogisticFitter",
        "estimator",
    ),
    a(
        "stats.gompertz_fitter",
        "lifelines.GompertzFitter",
        "function",
    ),
    a(
        "stats.GompertzFitter",
        "lifelines.GompertzFitter",
        "estimator",
    ),
    a(
        "stats.mixture_cure_fitter",
        "lifelines.MixtureCureFitter",
        "function",
    ),
    a(
    ...
    a(
        "stats.cif_se",
        "sksurv.metrics.cumulative_incidence",
        "function",
    ),
    a(
        "stats.scaled_schoenfeld",
        "lifelines.statistics.proportional_hazard_test",
        "function",
    ),
    ...
    a(
        "tslearn.Rist",
        "sktime.classification.hybrid.RISTClassifier",
        "estimator",
    ),
    a(
    ...
    a(
        "tslearn.BossVs",
        "sktime.classification.dictionary_based.BOSSVS",
        "estimator",
    ),
    a(
        "tslearn.PeltAnnotator",
        "sktime.annotation.clasp.Pelt",
        "estimator",
    ),
    a(
        "tslearn.ClaSPAnnotator",
        "sktime.annotation.clasp.ClaSP",
        "estimator",
    ),
    a(
        "stats.KaplanMeierFitter",
        "lifelines.KaplanMeierFitter",
        "estimator",
    ),
    a(
        "stats.NelsonAalenFitter",
        "lifelines.NelsonAalenFitter",
        "estimator",
    ),
    a(
        "stats.AalenJohansenFitter",
        "lifelines.AalenJohansenFitter",
        "estimator",
    ),
    ...
    a(
        "online.CyclicLrRegressor",
        "river.optim.schedulers.CyclicLR",
        "online",
    ),
    a(
    ...
    a(
        ...
        "river.optim.schedulers.OneCycleLR",
        "online",
    ),
    a(
    ...
    a(
        "tsa.MstlForecaster",
        "sktime.forecasting.mstl.MSTLForecaster",
        "forecast",
    ),
    a(
        "tsa.ThresholdAr",
    ...
    a(
        "glm.ExponentialAftFitter",
        "lifelines.ExponentialFitter",
        "estimator",
    ),
    a(
        "glm.LogLogisticAftFitter",
        "lifelines.LogLogisticAFTFitter",
        "estimator",
    ),
    a(
        "glm.LogNormalAftFitter",
        "lifelines.LogNormalAFTFitter",
        "estimator",
    ),
    a(
        "glm.GompertzAftFitter",
        "lifelines.GompertzFitter",
        "estimator",
    ),
    a(
        "online.LookaheadRegressor",
        "river.optim.Lookahead",
        "online",
    ),
    a(
        "online.AlmaClassifier",
    ...
    a(
        "tslearn.hidalgo",
        "sktime.annotation.stray.Hidalgo",
        "function",
    ),
    a(
        "tslearn.Hidalgo",
    ...
    a("panel.SunAbraham", "statsmodels.treatment.api", "estimator"),
    a(
        "stats.SLearner",
    ...
    a("stats.CausalForest", "econml.grf.CausalForest", "estimator"),
    a(
    ...
    a(
        "tsa.reconcile_wls",
        "sktime.forecasting.reconcile.wls",
        "function",
    ),
    a(
    ...
    a(
        "tslearn.Floss",
        "sktime.annotation.clasp.FLOSS",
        "timeseries",
    ),
    a(
        "tslearn.floss_change_point",
        "sktime.annotation.clasp.FLOSS",
        "function",
    ),
    a(
    ...
    a("tslearn.cdist_clark", "tslearn.metrics.cdist", "timeseries"),
    ...
    a("tslearn.dice_distance", "tslearn.metrics.dtw", "timeseries"),
    a("tslearn.cdist_dice", "tslearn.metrics.cdist", "timeseries"),
...
mod tests {
    ...
    fn generated_includes_type_baked_families() {
        ...
        assert!(inventory()
            .iter()
            .any(|a| a.name == "anomaly.KnnDistanceAnomaly"));
        assert!(inventory()
            .iter()
            .any(|a| a.name == "hmm.HiddenMarkovModel"));
        assert!(gen.iter().all(|n| !n.contains("LogMinkowski")));
        assert!(inventory().iter().any(|a| a.name == "hmm.CosinePower"));
        assert!(gen.iter().all(|n| !n.contains("Cosine173")));
