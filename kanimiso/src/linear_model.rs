...
use number_ruler::linear::{empty_fitted, infer_point_fit, split_beta};
pub use number_ruler::linear::{FittedLinear, LinearRegression};
...
mod tests {
    use super::*;
    use number_ruler::linear::infer_ols;
