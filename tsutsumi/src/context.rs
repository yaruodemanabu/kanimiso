...
impl FitCtx {
    ...
    pub fn suppress_completion_recording(&mut self) {
    ...
    pub fn finish_failure(self) -> Failure {
        let primary = self
            .report
            .clone()
    ...
    pub fn merge_failure(mut self, failure: Failure) -> Failure {
...
mod tests {
    ...
    fn nested_failure_remains_primary_when_outer_issue_does_not_abort() {
        ...
        let nested_policy = Policy {
            abort_at: Severity::Warning,
            ..Policy::default()
        };
